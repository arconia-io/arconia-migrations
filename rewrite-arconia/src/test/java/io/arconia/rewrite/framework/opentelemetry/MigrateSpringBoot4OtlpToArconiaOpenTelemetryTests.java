package io.arconia.rewrite.framework.opentelemetry;
...
class MigrateSpringBoot4OtlpToArconiaOpenTelemetryTests implements RewriteTest {
    ...
    public void defaults(RecipeSpec spec) {
        spec.recipeFromResources("io.arconia.rewrite.framework.opentelemetry.MigrateSpringBoot4_0_OtlpToArconiaOpenTelemetry")
