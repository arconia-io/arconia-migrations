...
When upgrading to JUnit 6.x, refer to the https://docs.junit.org/6.0.0/release-notes/[JUnit 6.0 Release Notes] for newly introduced APIs, deprecated APIs, and breaking changes.
