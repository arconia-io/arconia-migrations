...
:cli-command: arconia rewrite run --recipe-name io.arconia.rewrite.testing.junit.UpgradeJUnit_6
:recipe-id: io.arconia.rewrite.testing.junit.UpgradeJUnit_6
...
See its xref:recipe-catalog/rewrite-testing.adoc#io_arconia_rewrite_testing_junit_UpgradeJUnit_6[entry in the Recipe Catalog] for the full list of recipes this upgrade applies, each with its options and a before/after example.
