...
When upgrading to Testcontainers 2, refer to the https://github.com/testcontainers/testcontainers-java/releases/tag/2.0.0[Testcontainers 2.0 Release Notes] for newly introduced APIs, deprecated APIs, and breaking changes.
