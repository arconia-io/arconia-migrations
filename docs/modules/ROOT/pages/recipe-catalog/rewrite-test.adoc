= rewrite-test
:description: OpenRewrite recipes published in the rewrite-test module.

// AUTO-GENERATED from the OpenRewrite recipe model. Do not edit by hand.

The `rewrite-test` module publishes 9 recipes across 3 categories.
...
[#io_arconia_rewrite_test_ConvertToRawType]
=== Convert parameterized types to raw types
`io.arconia.rewrite.test.ConvertToRawType`
...
[#io_arconia_rewrite_test_junit_UpgradeJUnit_6]
...
[#family-test-testcontainers]
== test › testcontainers

*Composite recipes*

[#io_arconia_rewrite_test_testcontainers_MigrateCassandraContainer_2]
=== Migrate Testcontainers `CassandraContainer` to the 2.x package
`io.arconia.rewrite.test.testcontainers.MigrateCassandraContainer_2`
...
[#io_arconia_rewrite_test_testcontainers_MigrateKafkaContainer_2]
=== Migrate Testcontainers `KafkaContainer` to the Apache replacement
`io.arconia.rewrite.test.testcontainers.MigrateKafkaContainer_2`
...
[%collapsible]
====
* xref:recipe-catalog/rewrite-test.adoc#io_arconia_rewrite_test_testcontainers_ChangeContainerImageName[Change the image name passed to a Testcontainers container] (`io.arconia.rewrite.test.testcontainers.ChangeContainerImageName`)
* Change type (`org.openrewrite.java.ChangeType`)
* xref:recipe-catalog/rewrite-test.adoc#io_arconia_rewrite_test_ConvertToRawType[Convert parameterized types to raw types] (`io.arconia.rewrite.test.ConvertToRawType` ×2)
====

[#io_arconia_rewrite_test_testcontainers_MigrateLocalStackContainer_2]
=== Migrate Testcontainers `LocalStackContainer` to the 2.x package and API
`io.arconia.rewrite.test.testcontainers.MigrateLocalStackContainer_2`
...
[%collapsible]
====
* xref:recipe-catalog/rewrite-test.adoc#io_arconia_rewrite_test_testcontainers_MigrateLocalStackServiceEnum_2[Replace `LocalStackContainer.Service` enum constants with string literals] (`io.arconia.rewrite.test.testcontainers.MigrateLocalStackServiceEnum_2`)
...
* xref:recipe-catalog/rewrite-test.adoc#io_arconia_rewrite_test_testcontainers_MigrateLocalStackImageArg[Migrate LocalStackContainer bare-version constructor argument] (`io.arconia.rewrite.test.testcontainers.MigrateLocalStackImageArg`)
* Change type (`org.openrewrite.java.ChangeType`)
* xref:recipe-catalog/rewrite-test.adoc#io_arconia_rewrite_test_ConvertToRawType[Convert parameterized types to raw types] (`io.arconia.rewrite.test.ConvertToRawType`)
====

[#io_arconia_rewrite_test_testcontainers_UpgradeTestcontainers_2]
...
[#io_arconia_rewrite_test_testcontainers_MigrateLocalStackServiceEnum_2]
=== Replace `LocalStackContainer.Service` enum constants with string literals
`io.arconia.rewrite.test.testcontainers.MigrateLocalStackServiceEnum_2`
...
[#io_arconia_rewrite_test_testcontainers_ChangeContainerImageName]
=== Change the image name passed to a Testcontainers container
`io.arconia.rewrite.test.testcontainers.ChangeContainerImageName`
...
[#io_arconia_rewrite_test_testcontainers_MigrateLocalStackImageArg]
=== Migrate LocalStackContainer bare-version constructor argument
`io.arconia.rewrite.test.testcontainers.MigrateLocalStackImageArg`
