...
*** … and 13 more
** xref:recipe-catalog/rewrite-test.adoc#io_arconia_rewrite_test_junit_UpgradeJUnit_6[Migrate to JUnit 6.x] (`io.arconia.rewrite.test.junit.UpgradeJUnit_6`)
...
* Upgrade Gradle or Maven dependency versions (`org.openrewrite.java.dependencies.UpgradeDependencyVersion`)
* xref:recipe-catalog/rewrite-test.adoc#io_arconia_rewrite_test_testcontainers_UpgradeTestcontainers_2[Migrate to Testcontainers 2.x] (`io.arconia.rewrite.test.testcontainers.UpgradeTestcontainers_2`)
...
** Upgrade Gradle or Maven dependency versions (`org.openrewrite.java.dependencies.UpgradeDependencyVersion`)
** xref:recipe-catalog/rewrite-test.adoc#io_arconia_rewrite_test_testcontainers_MigrateCassandraContainer_2[Migrate Testcontainers `CassandraContainer` to the 2.x package] (`io.arconia.rewrite.test.testcontainers.MigrateCassandraContainer_2`)
*** Change type (`org.openrewrite.java.ChangeType`)
*** xref:recipe-catalog/rewrite-test.adoc#io_arconia_rewrite_test_ConvertToRawType[Convert parameterized types to raw types] (`io.arconia.rewrite.test.ConvertToRawType`)
*** Change type (`org.openrewrite.java.ChangeType` ×2)
** Change type (`org.openrewrite.java.ChangeType`)
** xref:recipe-catalog/rewrite-test.adoc#io_arconia_rewrite_test_ConvertToRawType[Convert parameterized types to raw types] (`io.arconia.rewrite.test.ConvertToRawType`)
** Change type (`org.openrewrite.java.ChangeType`)
