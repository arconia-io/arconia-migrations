...
[#io_arconia_rewrite_spring_boot4_AddRestClientModule]
=== Add RestClient Module
`io.arconia.rewrite.spring.boot4.AddRestClientModule`
...
====
* Change type (`org.openrewrite.java.ChangeType`)
* xref:recipe-catalog/rewrite-spring.adoc#io_arconia_rewrite_spring_boot4_AddRestClientModule[Add RestClient Module] (`io.arconia.rewrite.spring.boot4.AddRestClientModule`)
** Add Gradle or Maven dependency (`org.openrewrite.java.dependencies.AddDependency`)
====
