...
* Comment out properties removed in 2.0, including each provider's `spring.ai.<provider>.chat.options.internal-tool-execution-enabled`, `spring.ai.chat.client.tool-calling.stream-tool-call-responses`, and `spring.ai.chat.client.tool-search-advisor.stream-tool-call-responses`.
